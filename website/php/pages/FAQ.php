<?php
	...
	//Section, CollapseName, Description
	$FAQArray = array(
		array("section" => "FAQ",
			"id" => "What is the point of this website?",
		...
		array("section" => "HELP",
			"id" => "How to Change Your Account Details",
		...
		array("section" => "HELP",
			"id" => "How to Join an Organisation",
		...
		array("section" => "HELP",
			"id" => "How to Leave an Organisation",
		...
		array("section" => "HELP",
			"id" => "How to Receive and Change Notifications",
		...
		array("section" => "HELP",
			"id" => "How to create an organisation",
		...
		array("section" => "HELP",
			"id" => "How to edit your organisation’s details",
		...
		array("section" => "HELP",
			"id" => "How to Edit a Listing and Add an Image",
	        ...
	        <div class="panel panel-default">
	        	<div class="panel-heading" unselectable="on" onselectstart="return false;" onmousedown="return false;" data-toggle="collapse" href="#collapseFAQ'.$i.'">
	                <h4 class="panel-title">
	                    <a class="accordion-toggle" data-parent="#panel-group">'.$row['id'].'</a>
	                </h4>
	            </div>
